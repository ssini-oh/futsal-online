...
**Futsal Online**은 간단한 풋살 카드 게임 프로젝트로, Prisma와 Node.js를 기반으로 개발된 팀 프로젝트입니다. 사용자들은 카드를 수집하고 덱을 구성하여 다른 플레이어와 대결을 펼칠 수 있으며, 현재 프로젝트의 경우 백엔드 API 중심으로 설계되었습니다.
...
- 각 라운드에서 다음 로직을 반복:
  1. A팀 공격, B팀 수비:
     - A팀 공격 확률이 B팀 수비 확률을 초과하면 A팀 득점
  2. B팀 공격, A팀 수비:
     - B팀 공격 확률이 A팀 수비 확률을 초과하면 B팀 득점
- 최종 점수를 통해 승패 결정
